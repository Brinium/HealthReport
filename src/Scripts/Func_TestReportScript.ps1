...
$report.Health = [HealthCheck.Status]::Warning;
...
$report2 = New-Object HealthCheck.ReportItem;
...
$report2.Health = [HealthCheck.Status]::Success;
$report2.SubItems = [HealthCheck.ReportSubItem[]]@();
...
$report3 = New-Object HealthCheck.ReportItem;
...
$report3.Health = [HealthCheck.Status]::Success;
$report3.SubItems = [HealthCheck.ReportSubItem[]]@();
